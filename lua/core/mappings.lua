...
if is_available "nvim-toggleterm.lua" then
  ...
  local crunner = function()
    map("n", "<leader>r", "<cmd>TermExec cmd='cc % && ./a.out' <CR>")
  end

  local pythonrunner = function()
    map("n", "<leader>r", "<cmd>TermExec cmd='python %' <CR>")
  end

  local cpprunner = function()
    map("n", "<leader>r", "<cmd>TermExec cmd='g++ %  && ./a.out' <CR>")
  end


  local gorunner = function()
    map("n", "<leader>r", "<cmd>TermExec cmd='go run %'  <CR>")
  end


  vim.api.nvim_create_autocmd("BufEnter", {
    pattern = {"*.c", "*.h"},
    callback = crunner,  -- Or myvimfun
  })
